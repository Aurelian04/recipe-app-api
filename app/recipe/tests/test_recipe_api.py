...
class PrivateRecipeTests(TestCase):
    ...
    def test_delete_other_users_recipe_error(self):
        """Test tryng to delete another users recipe gives error."""
        new_user = create_user(email='user2@example.com', password='test123')
    ...
    def test_update_recipe_assign_tag(self):
        ...
        tag_breakfeast = Tag.objects.create(user=self.user, name='Breakfeast')
        recipe = create_recipe(user=self.user)
        recipe.tags.add(tag_breakfeast)
        ...
        self.assertNotIn(tag_breakfeast, recipe.tags.all())
